 ...
 lams.forEach( (element,i )=> {
    element.addEventListener('click' ,() =>{
      item_no = i;
        ...
        <li>${name}, daily income ${day_income}, daily yield ${profit}%, contract ${days} days, total income ${total_revenue}rs, total income rate ${profit * days}%, purchase limit unlimited.</li>
        <li> Invite friends to buy ${name} to get invitation rewards and team income</li>
        <li>You can enjoy discounts for balance purchases, you only need to pay ${price}*95%=${ (price/100) * 95}rs</li>`
